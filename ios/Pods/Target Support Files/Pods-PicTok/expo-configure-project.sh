...
with_node \
  ...
  --target "/Users/brandonkatz/Desktop/PicTok/ios/Pods/Target Support Files/Pods-PicTok/ExpoModulesProvider.swift" \
  --entitlement "/Users/brandonkatz/Desktop/PicTok/ios/PicTok/PicTok.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
